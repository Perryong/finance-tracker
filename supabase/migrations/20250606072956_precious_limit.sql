/*
  ...
  3. Enhanced Transactions
    - Payment methods
    - Transaction status and attachments
...
-- Create users table (replaces profiles dependency)
...
-- Create categories table (enhanced version)
...
-- Create audit logs table (without external dependencies)
...
-- User policies (users can only see/edit their own data)
