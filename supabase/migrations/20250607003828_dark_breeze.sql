/*
  # Complete Finance Tracker Database Schema

  1. New Tables
    - Enhanced profiles with additional user information
    - user_preferences for user customization settings
    - dashboard_metrics for financial overview tracking
    - dashboard_widgets for customizable dashboard layout
    - payment_methods for transaction payment tracking
    - Enhanced transactions with additional fields
    - transaction_attachments for receipt storage
    - financial_targets for goal tracking
    - target_progress for goal progress monitoring
    - target_notifications for goal alerts
    - account_types for chart of accounts
    - accounts for double-entry bookkeeping
    - ledger_entries and ledger_entry_lines for accounting
    - budgets and budget_categories for budget management
    - Enhanced audit_logs for comprehensive logging

  2. Security
    - Enable RLS on all tables
    - Comprehensive policies for data access control
    - User isolation for all financial data
  ...
  4. Business Logic
    - Automated dashboard metrics calculation
    - Double-entry bookkeeping validation
    - Target progress tracking
    - User initialization with default data
*/
...
SELECT drop_policy_if_exists('Users can manage own preferences', 'user_preferences');
SELECT drop_policy_if_exists('Users can manage own categories', 'categories');
SELECT drop_policy_if_exists('Users can view own categories', 'categories');
SELECT drop_policy_if_exists('Users can insert own categories', 'categories');
SELECT drop_policy_if_exists('Users can update own categories', 'categories');
SELECT drop_policy_if_exists('Users can delete own categories', 'categories');
SELECT drop_policy_if_exists('Users can manage own dashboard metrics', 'dashboard_metrics');
SELECT drop_policy_if_exists('Users can manage own dashboard widgets', 'dashboard_widgets');
SELECT drop_policy_if_exists('Users can manage own payment methods', 'payment_methods');
SELECT drop_policy_if_exists('Users can manage own transactions', 'transactions');
SELECT drop_policy_if_exists('Users can view own transactions', 'transactions');
SELECT drop_policy_if_exists('Users can insert own transactions', 'transactions');
SELECT drop_policy_if_exists('Users can update own transactions', 'transactions');
SELECT drop_policy_if_exists('Users can delete own transactions', 'transactions');
SELECT drop_policy_if_exists('Users can manage own transaction attachments', 'transaction_attachments');
SELECT drop_policy_if_exists('Users can manage own financial targets', 'financial_targets');
SELECT drop_policy_if_exists('Users can manage own target progress', 'target_progress');
SELECT drop_policy_if_exists('Users can manage own target notifications', 'target_notifications');
SELECT drop_policy_if_exists('Users can manage own account types', 'account_types');
SELECT drop_policy_if_exists('Users can manage own accounts', 'accounts');
SELECT drop_policy_if_exists('Users can manage own ledger entries', 'ledger_entries');
SELECT drop_policy_if_exists('Users can manage own ledger entry lines', 'ledger_entry_lines');
SELECT drop_policy_if_exists('Users can manage own budgets', 'budgets');
SELECT drop_policy_if_exists('Users can manage own budget categories', 'budget_categories');
SELECT drop_policy_if_exists('Users can view own audit logs', 'audit_logs');
SELECT drop_policy_if_exists('System can insert audit logs', 'audit_logs');
SELECT drop_policy_if_exists('Users can view own settings', 'user_settings');
SELECT drop_policy_if_exists('Users can insert own settings', 'user_settings');
SELECT drop_policy_if_exists('Users can update own settings', 'user_settings');
SELECT drop_policy_if_exists('Users can manage own settings', 'user_settings');
...
SELECT drop_trigger_if_exists('update_profiles_updated_at', 'profiles');
SELECT drop_trigger_if_exists('update_user_preferences_updated_at', 'user_preferences');
SELECT drop_trigger_if_exists('update_categories_updated_at', 'categories');
SELECT drop_trigger_if_exists('update_dashboard_metrics_updated_at', 'dashboard_metrics');
SELECT drop_trigger_if_exists('update_dashboard_widgets_updated_at', 'dashboard_widgets');
SELECT drop_trigger_if_exists('update_payment_methods_updated_at', 'payment_methods');
SELECT drop_trigger_if_exists('update_transactions_updated_at', 'transactions');
SELECT drop_trigger_if_exists('update_financial_targets_updated_at', 'financial_targets');
SELECT drop_trigger_if_exists('update_target_notifications_updated_at', 'target_notifications');
SELECT drop_trigger_if_exists('update_account_types_updated_at', 'account_types');
SELECT drop_trigger_if_exists('update_accounts_updated_at', 'accounts');
SELECT drop_trigger_if_exists('update_ledger_entries_updated_at', 'ledger_entries');
SELECT drop_trigger_if_exists('update_budgets_updated_at', 'budgets');
SELECT drop_trigger_if_exists('update_budget_categories_updated_at', 'budget_categories');
SELECT drop_trigger_if_exists('update_user_settings_updated_at', 'user_settings');
SELECT drop_trigger_if_exists('trigger_update_dashboard_metrics', 'transactions');
SELECT drop_trigger_if_exists('trigger_validate_ledger_balance', 'ledger_entry_lines');
SELECT drop_trigger_if_exists('trigger_update_account_balance', 'ledger_entry_lines');
SELECT drop_trigger_if_exists('trigger_update_target_progress', 'target_progress');
SELECT drop_trigger_if_exists('trigger_initialize_user_data', 'profiles');
